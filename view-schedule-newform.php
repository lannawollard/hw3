  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newCourseModalLabel">New schedule</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="sMorning" class="form-label">Schedule morning</label>
            <input type="text" class="form-control" id="cNumber" name="cNumber">
          </div>
          <div class="mb-3">
            <label for="sNight" class="form-label">Schedule night</label>
