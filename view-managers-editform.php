    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="mTime<?php echo $manager['manager_id']; ?>" class="form-label">Manager Time</label>
            <input type="text" class="form-control" id="mTime<?php echo $manager['manager_id']; ?>" name="mTime" value="<?php echo $manager['manager_time']; ?>">
          </div>
